...
<body>
	<div class="bjui-pageContent">
		<form:form class="nice-validator n-red" data-alertmsg="false"
			data-toggle="validate" action="risktime/alterUpdateRiskTime"
			novalidate="novalidate" modelAttribute="risktime" id="useraddfrom">
				...
				<tr>
					<td><label class="control-label x85" for="j_custom_name">开始时间：</label>
						<form:input path="beginTime" type="text" 
							class="form-control" size="15" data-pattern="yyyyMMdd" /></td>
				</tr>
				<tr>
