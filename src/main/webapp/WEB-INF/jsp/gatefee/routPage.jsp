...
<body>
	<div class="bjui-pageHeader">
		<form:form id="pagerForm" name="transRateCountForm"
			...
			action="${pageContext.request.contextPath}/gatefee/search" method="post"
			modelAttribute="rout">
			...
			<div class="bjui-searchBar">
				...
				&nbsp; <a class="btn btn-green" data-title="增加" data-id="form"
					data-toggle="dialog" data-width="800" data-height="400" data-id="user-add" href="gatefee/addpage">增加</a>
			</div>
		</form:form>
	</div>
...
<tr data-id="<c:out value="${record.gateId}"/>">
      ...
      <td align="center"><c:out value="${record.calcMode}"/></td>
      <td align="center"><c:out value="${record.remark}"/></td>
      <td align="center">
      	<a class="btn btn-green" data-title="修改" data-id="form"
					data-toggle="dialog" data-width="800" data-height="400" data-id="user-update" href="gatefee/updatepage/${record.gateId}/${record.posMerId}/${record.posTermId}">修改</a>
		<a class="btn btn-red" data-confirm-msg="确定要删除该行信息吗？" data-toggle="doajax" href="gatefee/delete/${record.gateId}/${record.posMerId}/${record.posTermId}">删除</a></td>
		</td>
    </tr>
  </c:forEach>
    </tbody>
