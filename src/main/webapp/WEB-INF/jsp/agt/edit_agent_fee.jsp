...
<div class="bjui-pageContent tableContent">
    <form id="pagerForm" name="agentFeeForm" data-toggle="validate" novalidate="novalidate" action="${pageContext.request.contextPath}/agtInfo/update_agtFee_setting" method="post">
        <div class="bjui-searchBar">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading"><h3 class="panel-title">代理商费率信息</h3></div>
                    <div class="panel-body">
                        <input type="hidden" id="agentId" value="${agentFeeForm.agentId}" name="agentId" class="form-control">
                        <table width="100%">
                            <tr>
                            ...
                            <tr>
                                <td align="right"> <label>借记卡封顶：</label></td><td align="left"><input type="text"  value="${agentFeeForm.fee01L}"  class="form-control" size="15" disabled="true"></td>
                                <td align="right"> <label>修改后借记卡封顶：</label></td><td align="left"><input type="text" id="fee01L" value="${agentFeeForm.fee01L}" name="fee01L" class="form-control" size="15" ></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="right"> <label>07 T0提现费率（%）：</label></td><td align="left"><input type="text" value="${agentFeeForm.fee07}"  class="form-control" size="15" disabled="true"></td>
                                <td align="right"> <label>修改后07 T0提现费率（%）：</label></td><td align="left"><input type="text" id="fee07" value="${agentFeeForm.fee07}" name="fee07" class="form-control" size="15" ></td>
                            </tr>

                            <tr>
                                <td align="right"> <label>08 T1提现费率（%）：</label></td><td align="left"><input type="text" value="${agentFeeForm.fee08}" class="form-control" size="15" disabled="true"></td>
                                <td align="right"> <label>修改后08 T1提现费率（%）：</label></td><td align="left"><input type="text" id="fee08" value="${agentFeeForm.fee08}" name="fee08" class="form-control" size="15" ></td>
                            </tr>
                        </table>
                    </div>
                </div>
