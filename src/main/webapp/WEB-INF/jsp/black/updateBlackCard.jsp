...
<body>
	<div class="bjui-pageContent">
		<form:form class="nice-validator n-red" data-alertmsg="false"
			data-toggle="validate" action="blackcard/alterUpdateBlackCard"
			novalidate="novalidate" modelAttribute="blackcard" id="useraddfrom">
			<table class="table table-condensed table-hover" width="100%">
				<tr>
					<td><label class="control-label x85" for="j_custom_name">卡号：</label>
						<form:input path="cardNo" class="form-control" type="text"
