...
<form id="pagerForm" name="funcManageForm" data-toggle="validate" novalidate="novalidate" action="${pageContext.request.contextPath}/funcManagement/updatefunc" method="post">
    <div class="bjui-searchBar">
      ...
      <br>
      <label>父资源&nbsp;ID&nbsp;：</label>
      <input type="text" value="<c:out value="${funcManageForm.funcFatherId}"/>" name="funcFatherId" size="30" />&nbsp;<br><br>

      <label>描&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;述：</label>
      <input type="text" value="<c:out value="${funcManageForm.funcDesc}"/>" name="funcDesc" size="30" />&nbsp;<br><br>

      <label>备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：</label>
      <input type="text" value="<c:out value="${funcManageForm.funcRemark}"/>" name="funcRemark" size="30" />&nbsp;<br><br>


      <label>标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;签：</label>
      <input type="text" value="<c:out value="${funcManageForm.funcTag}"/>" name="funcTag" size="30" />&nbsp;<br><br>

      <label>等&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;级：</label>
      <input type="text" value="<c:out value="${funcManageForm.funcLevel}"/>" name="funcLevel" size="30" />&nbsp;<br><br>

      <label>权限字符串：</label>
      <input type="text" value="<c:out value="${funcManageForm.funcUrl}"/>" name="funcUrl" size="30" />&nbsp;<br><br>

      <label>图标字符串：</label>
      <input type="text" value="<c:out value="${funcManageForm.funcIcon}"/>" name="funcIcon" size="30" />&nbsp;<br><br>

      <label>优&nbsp;&nbsp;&nbsp;先&nbsp;&nbsp;&nbsp;级：</label>
      <input type="text" value="<c:out value="${funcManageForm.funcPriority}"/>" name="funcPriority" size="30" data-rule="优先级:required" />&nbsp;<br><br>
