...
<body>
	<div class="bjui-pageContent">
		<form:form class="nice-validator n-red" data-alertmsg="false"
			data-toggle="validate" action="riskctrlregl/update"
			novalidate="novalidate" modelAttribute="rout" id="riskCtrlReglForm">
			<table class="table table-condensed table-hover" width="100%">
				<tr>
					<td><label class="control-label x85" for="j_custom_name">风控编号：</label>
						<form:input path="riskNum" class="form-control" type="text"
				...
				<tr>
					<td><label class="control-label x85" for="j_custom_name">参数编号：：</label>
						<form:input path="paramNum" class="form-control" type="text"
							...
							aria-required="true" readonly="true"/></td>
				</tr>
				<tr>
					<td><label class="control-label x85" for="j_custom_name">参数值：</label>
						<form:input path="paramVal" class="form-control" type="text"
							size="15" name="custom.name" style="width: 150px;"
