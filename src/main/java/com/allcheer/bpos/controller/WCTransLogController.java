...
@Controller
@RequestMapping("wctrans")
public class WCTransLogController {

    private static final Logger logger = LoggerFactory.getLogger(WCTransLogController.class);
