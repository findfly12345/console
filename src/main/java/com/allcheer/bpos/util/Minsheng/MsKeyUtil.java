...
public class MsKeyUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte[] enBytes = MsKeyUtil.encryptAES(data, keyStr.getBytes(), false, "GBK");
        long endTime1 = System.currentTimeMillis();
        System.out.println("time1:" + (endTime1 - startTime1) / 1000);

        long startTime2 = System.currentTimeMillis();
        byte[] deBytes = MsKeyUtil.decryptAES(enBytes, keyStr.getBytes(), false, "GBK");
