...
public class MerDetailInfo {
    ...
    private List<MerFee> merFeeList;
    ...
    private List<PhotoBO> merPhotos;
    ...
    public List<MerFee> getMerFeeList() {
        return merFeeList;
    }

    public void setMerFeeList(List<MerFee> merFeeList) {
        this.merFeeList = merFeeList;
    }
    ...
    public List<PhotoBO> getMerPhotos() {
        return merPhotos;
    }

    public void setMerPhotos(List<PhotoBO> merPhotos) {
        this.merPhotos = merPhotos;
    }
}
