 ...
 */
public class InstChannelMapForm extends BaseForm{
    ...
    public void setUploadMapFile(String uploadMapFile) {
        this.uploadMapFile = uploadMapFile == null ? null : uploadMapFile.trim();
    }

    public String getUploadMapFile() {
