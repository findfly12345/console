...
<div class="bjui-pageContent tableContent" id="addMerInfo">
    <form id="pagerForm" name="terminalForm" data-toggle="validate" novalidate="novalidate" action="${pageContext.request.contextPath}/terminal/bind_terminal_mer" method="post">
