...
<div class="bjui-pageHeader">
    <form id="pagerForm" name="terminalForm" data-toggle="ajaxsearch" action="${pageContext.request.contextPath}/terminal/manage_terminal_list" method="post">
        ...
        <div class="bjui-searchBar">
            ...
            <a href="${pageContext.request.contextPath}/terminal/terminal_info_add" class="btn btn-green" data-toggle="navtab" data-id="form-viewagtinfo"  data-title="新增终端">新增终端</a>
        </div>
    </form>
</div>
    ...
    <table  class="table table-bordered table-hover table-striped table-top" data-toggle="tablefixed" data-width="100%" data-nowrap="true">
        ...
        <c:forEach var="record" items="${terminalForm.pagination.list}" varStatus="status">
            <tr data-id="<c:out value="${record.termId}"/>">
                ...
                <td align="center">
                    <a href="${pageContext.request.contextPath}/terminal/terminal_info_edit?termId=${record.termId}" class="btn btn-green" data-toggle="navtab" data-id="form-viewagtinfo"  data-title="编辑">编辑</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
