...
<div class="bjui-pageHeader">
    <form:form id="pagerForm" name="tblMerCoreMccDo" data-toggle="ajaxsearch" action="${pageContext.request.contextPath}/mer/go_to_select_mer_mcc" method="post"
               modelAttribute="tblMerCoreMccDo">
