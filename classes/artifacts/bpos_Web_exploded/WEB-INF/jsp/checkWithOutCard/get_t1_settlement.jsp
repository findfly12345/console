...
<script language="javascript">
	function prtReport() {
		checkFileForm.action = '${pageContext.request.contextPath}/checkWithOutCard/download';
...
<body>
	<div class="bjui-pageHeader">
		<form:form id="pagerForm" name="checkFileForm"
			...
			action="${pageContext.request.contextPath}/checkWithOutCard/get_t1_settlement"
			...
			<div class="bjui-searchBar">
				...
				<div class="form-group" style="margin: 20px 0 20px;">
					...
					<form:input type="text" path="filterDate" data-pattern="yyyyMMdd"
	...
	<div class="bjui-pageContent tableContent">
		<c:if test="${tblT1CheckFileRespondeDoList!=null}">
			<table
				...
				<tbody>
					<c:forEach var="tblT1CheckFileRespondeDo"
						items="${tblT1CheckFileRespondeDoList}">
						<tr>
